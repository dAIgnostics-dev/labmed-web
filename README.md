...
- `assets/` — official dAIgnostics logo (`daignostics-logo.png`, transparent, trimmed from the 900x900 master), favicons (`favicon.ico`, `icon-192.png`, `icon-512.png`, `apple-touch-icon.png`, cut from the product wordmark), Adarsh Sans font, hero photo (`hero-labmed.jpg`)
